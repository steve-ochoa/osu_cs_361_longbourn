...
var cur_request = new XMLHttpRequest();
cur_request.open('POST', "http://localhost:6997/companies/", false);
cur_request.setRequestHeader('Content-Type', 'application/json');
cur_payload = {
	companyId: 0,
	name: "Pokemon Industries",
	description: "Vendor of fine Pokemon",
	industry: "Illegal animal trafficking"

};

cur_request.send(JSON.stringify(cur_payload));
console.log(cur_request.responseText);
//console.log(JSON.parse(cur_request.responseText));
