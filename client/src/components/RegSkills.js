...
export default function RegSkills(props) {
  ...
  async function handleSubmit() {
    ...
    if (updatedFields.length === 1 && location.pathname === "/register2") {
      if (
  ...
  return (
    <>
      <head>
        <title>Register Skills</title>
      </head>
      <div className={"registerSkillsHeader"}>
        <h2>Add Skills</h2>
        <br />
        <p>
          Which tech skills do you have?
          <br />
          Add a tech skill by entering the technology name (e.g. "Python", or
          "Node.js") and selecting it from the list. <br />
          Then select how many years of experience you have with this
          technology.
          <br />
