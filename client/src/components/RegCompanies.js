    ...
    return (
        <>
            <div className={'registerCompaniesHeader'}>
                <h2>Add Work Experience</h2><br/>
                <p>Which companies have you worked at?<br/>
                    Add a company by entering the company name (e.g. "NVIDIA", or "Microsoft") and selecting it from
                    the list. <br/>
                    Then enter the position held and years working in that position.<br/>
