    ...
    return (
        <>
          ...
          <div className={'registerCoursesHeader'}>
            ...
            <p>Which university courses have you passed?<br/>
              Add a course by entering the course number (e.g. "CS361", or "CS372") and selecting it from
              the list. <br/>
              You can also add a course by selecting it from the dropdown list. <br/><br/>
              Then select the semester, year, and grade from the lists.<br/>
